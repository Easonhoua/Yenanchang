		...
		<view class="re-top">
			...
			<view class="amountbox">
				<view class="re-cell inner">
					...
					<text class="price">{{reserveData.reserveNum}}</text>
				</view>
			</view>
			<view class="timebox">
			...
			<view class="timebox">
				<view class="inner" style="padding-bottom:20rpx;padding-top:20rpx;">
					<view class="infor-cell">
						<text class="label">使用状态：</text>
						<view class="infor-cell-bd">{{reserveData.useStatusName}}</view>
					</view>
					<view class="infor-cell">
			...
			<view class="timebox" v-if="activityData.shopId">
					<view class="address-list">
						<!-- <view class="re-cell title">
							<view class="list">
								<image class="img" src="../../static/img/consult/main2.png"></image>
								<text>体育场</text>
