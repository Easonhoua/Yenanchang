<template>
    <view class="stack">
      ...
      @transitionend="onTransitionEnd(index)">
       <!-- <view v-html="item.html" class="imgbox-slice"></view> -->
	   <view class="imgbox-slice">
	   		<image class="img" :src="item.thumbnailPath"></image>
	   		<view class="img-address">
	   			<view class="name">{{item.shopName}}</view>
	   			<view class="address"><image class="icon" src="../../static/img_new/common/location@3x.png" @click="gotoMapLocation(item)"></image>{{item.address}}</view>
	   		</view>
		</view>
      </view>
    </view>
...
<script>
import detectPrefixes from '@/common/js/detect-prefixes.js';
export default {
  props: {
    stackinit: {
      type: Object,
  ...
  computed: {
    // 划出面积比例
    offsetRatio () {
      let width =347; //this.$el.offsetWidth
      let height =284;// this.$el.offsetHeight
